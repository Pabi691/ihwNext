      ...
      <MainLayOut>
        ...
        <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800">
          ...
          <section className="space-y-4">
            ...
            <p>
              This website is operated by <strong>Indian Hair World</strong>.
              Throughout the site, the terms “we”, “us” and “our” refer to Indian Hair World.
            </p>
            <p>
              Indian Hair World offers this website, including all information, tools
          ...
          <section className="mt-8 space-y-4">
            ...
            <p>
              We have made every effort to display as accurately as possible the colors and images of our products that appear at the store. We cannot guarantee that your computer monitor’s display of any color will be accurate.            </p>
            <p>
          ...
          <section className="mt-8 space-y-4">
            ...
            <p>
              ...
              right to limit or prohibit orders that, in our sole judgment, appear to be placed
          ...
          <section className="mt-8 space-y-4">
            ...
            <p>
              Any use by you of the optional tools offered through the site is entirely at your
          ...
          <section className="mt-8 space-y-4">
            ...
            <p>
              ...
              any comments you make and their accuracy. We take no responsibility and
          ...
          <section className="mt-8 space-y-4">
            ...
            <p>
              ...
              rules, laws, or local ordinances; <br />
          ...
          <section className="mt-8 space-y-4">
            ...
            <p className="font-medium">indianhairworld.services@gmail.com</p>

            <div className="mt-4">
              <p className="font-semibold">Indian Hair World</p>
              <p>Kolkata: 1A, Sultan Alam Rd, Lake Gardens, WB 700033</p>
              <p>📞 +91 7980221032 / +91 8910097668</p>
            </div>

            <div className="mt-4">
              <p className="font-semibold">Salt Lake</p>
              <p>EC-20, Sector 1, Salt Lake City, Kolkata 700064</p>
              <p>📞 +91 8961194044</p>
            </div>
