...
const BannerCards = [
  {
    title: "mobileBanner1",
    imgSrc: `${""}/images/mobile/women_banner_1.png`,
    slug: "#",
  },
  {
    title: "mobileBanner2",
    imgSrc: `${""}/images/mobile/women_banner_2.png`,
    slug: "#",
  },
  {
    title: "mobileBanner4",
    imgSrc: `${""}/images/mobile/women_banner_3.png`,
    slug: "#",
  },
];

const CatWomenMobile = () => {
  return (
    <div>
      <Swiper
        modules={[Autoplay]}
